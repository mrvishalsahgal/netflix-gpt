        ...
        createUserWithEmailAndPassword(auth, emailValue, passValue)
          .then((userCredential) => {
            updateProfile(userCredential.user, {
              displayName: "Vishal Sahgal",
              photoURL:
                "https://media.licdn.com/dms/image/v2/D4D03AQFOZW_EtuKXjg/profile-displayphoto-scale_100_100/B4DZgH3XMWHwAo-/0/1752478619635?e=1771459200&v=beta&t=I_8zZxyK-xJuqpHlpudcwdUlKPbOtfwknsSMYnvAQpY",
            })
              .then(() => {
